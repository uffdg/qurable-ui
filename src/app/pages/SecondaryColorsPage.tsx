...
import { secondaryColorGroups } from "../data/colors";
import imgUnion from "figma:asset/3953c83e1a838d3b143cbd033328681b8ef65ef6.png";

export function SecondaryColorsPage() {
  const [search, setSearch] = useState("");

  const filtered = secondaryColorGroups
    .map((group) => ({
      ...group,
        ...
        <div className="relative flex items-start justify-between gap-4 flex-wrap">
          <div className="max-w-xl">
            ...
            <p className="text-[#63626F] text-base leading-relaxed">
              The supporting actors of your design palette. They play a vital role, complementing
              your primary color and adding visual interest without stealing the spotlight.
            </p>
          </div>
