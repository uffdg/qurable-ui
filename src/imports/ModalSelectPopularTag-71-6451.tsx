import svgPaths from "./svg-txgrconosr";
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative" data-name="Frame">
      <p className="flex-[1_0_0] font-['PP_Neue_Montreal:Book',sans-serif] leading-[22px] min-h-px min-w-px not-italic relative text-[#2f2e35] text-[16px] tracking-[-0.112px] whitespace-pre-wrap">String</p>
    </div>
  );
}
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[8px] relative w-full">
          <div className="font-['Neue_Montreal:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#63626f] text-[0px] text-[16px] w-full whitespace-pre-wrap">
            <p className="font-['Neue_Montreal:Bold',sans-serif] mb-0">String</p>
            <p>Text value used to pass labels, buttons, identifiers, or custom copy to the front-end.</p>
          </div>
        </div>
      </div>
    </div>
