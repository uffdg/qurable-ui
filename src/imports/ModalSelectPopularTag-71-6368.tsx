import svgPaths from "./svg-146123cu0c";
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative" data-name="Frame">
      <p className="flex-[1_0_0] font-['PP_Neue_Montreal:Book',sans-serif] leading-[22px] min-h-px min-w-px not-italic relative text-[#2f2e35] text-[16px] tracking-[-0.112px] whitespace-pre-wrap">Select an attribute</p>
    </div>
  );
}
