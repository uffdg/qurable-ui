...
const COMPONENTS: ComponentDef[] = [
  ...
  },
  {
    ...
    description: "Key-value pair input row for adding structured metadata to coupons.",
    category: "Forms",
    tokens: ["Gray 20 (#D7D6DB)", "Destructive 50 (#F43F5E)"],
    usedIn: ["Coupon editor — Media"],
    previewBg: "#F8F8FA",
    wide: true,
    preview: (
      <div className="w-full max-w-lg space-y-3">
        <div className="flex items-end gap-3">
          <div className="flex-1">
            <label className="text-xs font-semibold text-[#3A3941] block mb-1.5">String key</label>
            <input className="w-full border border-[#D7D6DB] rounded-full px-3 py-2.5 text-sm text-[#3A3941] outline-none focus:border-[#9875FA] bg-white" placeholder="promo_code" />
          </div>
          <div className="flex-1">
            <label className="text-xs font-semibold text-[#3A3941] block mb-1.5">String value</label>
            <input className="w-full border border-[#D7D6DB] rounded-full px-3 py-2.5 text-sm text-[#3A3941] outline-none focus:border-[#9875FA] bg-white" placeholder="SUMMER25" />
          </div>
          <button className="mb-0.5 p-2.5 text-[#F43F5E] hover:bg-[#FFF1F2] rounded-lg transition-colors">
            🗑
          </button>
        </div>
        <button className="flex items-center gap-1.5 text-[#6430F7] text-sm font-semibold hover:underline">
